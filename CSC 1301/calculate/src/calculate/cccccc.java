...
import java.util.*;
public class cccccc {
	private static Stack <Character> s; //stack
	
    public static void main(String[] args) //main
    {
    	String repeat="a";
    	cccccc p = new cccccc(); //calculator
    	do{
    ...
    public static void evaluatePostfix(String str, int x)
    {
    ...
    public static boolean isOperator(char option)
    {
        switch(option)
        {
            case '+': return true;
    ...
    public static boolean highPriority(char option1, char option2)
    {
    ...
    public static int priorityLevel(char option)
    {
        int pl;
        switch(option)
        {
    ...
    public static int isRightFormat(int r, int l)
    {
        if (r == l) return 0;
        if (r > l) return 1;
        else return -1;
